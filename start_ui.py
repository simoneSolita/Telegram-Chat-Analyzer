...
from manager.properties_manager import write_property
from manager.ui_manager import search_user_db, search_sentence_db
...
with gr.Blocks() as demo:
    ...
    with gr.Tab("DB List") as tab_scan_db:
        with gr.Row() as dbs_row:
            ...
            scan_db_text_button.click(write_property(property_key=PROPERTIES_FILE_JSON_NAME,
                                                     property_value=dropdown), [], [])
    ...
    with gr.Column() as query_col:
        ...
        user_text_button.click(ui_function_search_user, inputs=user_text_input, outputs=user_text_output)
        sentence_text_button.click(ui_function_search_sentence, inputs=sentence_text_input,
